...
const project = [
    {
        ...
        description : "The Loan Management System, built with Java Servlets and JSP, lets users manage loan details, update payments, and estimate payoff timelines based on salary, using MySQL for data storage." ,
    ...
    }, 
    {
        ...
        description : "A simple weather application built with JavaScript that displays real-time weather information and changes the background dynamically based on the time of day." ,
    ...
    },
    {
        ...
        language : "python" ,
        description : "A Python file cleanup tool that deletes files over a specified size, prompting the user for confirmation, and removes empty directories afterward.",
